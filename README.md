...
- [ ] Explain benefit(s) using `client-side routing`?
  > Answer: client-side-routing is the process of using the browser to render the data within a website. It allows for less load on the server, as well speeds up the process.
- [ ] What does AJAX stand for?
  > Answer: Asynchronous JavaScript and XML.
- [ ] What are `controlled components` in React?
  > Answer: A controlled component is a form element that is controlled by input in React. Essentially, it is a Reaction to an input within React that you can see in the UI usually.
- [ ] Name three tools/libraries for making AJAX requests.
  > Answer: React-Router, ReactDOM, useEffect
